...
export default {
  ...
  methods: {
    generateSeatMap() {
      // Generate a sample seat map - this can be modified based on your needs
      const sections = []
      for (let s = 0; s < 3; s++) {
        const rows = []
        for (let r = 0; r < 5; r++) {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div class="bg-white p-6 rounded-lg shadow">
            <div class="mb-6">
              ...
              <div v-if="selectedSeats.length === 0" class="text-gray-500">
                No seats selected
              </div>
              <div v-else>
            ...
            <div class="border-t pt-4">
              ...
              <button 
                ...
                class="w-full bg-blue-600 text-white py-3 rounded-lg font-medium disabled:bg-gray-400 disabled:cursor-not-allowed hover:bg-blue-700"
              >
                Proceed to Checkout
              </button>
            </div>
